...
const ChatPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error("An unexpected error occurred while fetching:", error);
      const errorMessage = {
        id: Date.now() + 1,
        sender: "bot",
        text: "An unexpected error occurred while fetching",
      };
      setMessages((prev) => [...prev, errorMessage]);
    } finally {
      setLoading(false);
        ...
        {loading && (
          <div className="flex justify-start mb-4">
            <div className="flex space-x-1">
              ...
              <span className="block rounded-full bg-gray-300 h-2 w-2 animate-bounce delay-100"></span>
